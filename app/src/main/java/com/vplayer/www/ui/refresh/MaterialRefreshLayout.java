package com.vplayer.www.ui.refresh;
...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        fristRefresh = t.getBoolean(R.styleable.MaterialRefreshLayout_fristRefresh, false);
        moreRefresh = t.getBoolean(R.styleable.MaterialRefreshLayout_MoreRefresh, false);
        t.recycle();
    }
    ...
    public void setFristRefresh(boolean frist) {
        this.fristRefresh = frist;
    }

    public void setMoreRefresh(boolean more) {
        this.moreRefresh = more;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy >= 16 && !canChildScrollUp() && fristRefresh) {
                    if (isLoadMoreing) {
                        ToastUtil.showShort(getContext(), "更多正在加载...");
                        return false;
                    } else {
                ...
                } else if (dy < -16 && !canChildScrollDown() && isLoadMore && moreRefresh) {
                    LogUtil.e("下拉上滑距离："+dy);
                    if (isRefreshing) {
                        ToastUtil.showShort(getContext(), "刷新正在加载...");
                        return false;
                    } else {
